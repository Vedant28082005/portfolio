...
const timeline = [
  {
    ...
    title: 'IoT Hackathon — 1st Place',
    items: ['ESP32', 'ESP8266', 'IoT', 'Deep Learning'],
    desc: 'Won 1st place at PDEU\'s Industry Approach to IoT with Deep Learning hackathon. Built an Industrial Monitoring and Intruder Detection System.',
  },
  {
    year: 'Aug 2025',
    dotColor: 'bg-[#00D4FF]',
    ...
    title: 'IoT + ML — Edge Classifier',
    items: ['ESP32', 'Scikit-learn', 'Flask', 'Random Forest'],
    desc: 'Deployed a Random Forest weather classifier served via Flask, with temperature and humidity streamed live from an ESP32.',
  },
  {
    year: 'Sep 2025',
    dotColor: 'bg-[#00D4FF]',
    ...
    labelColor: 'text-[#00D4FF]',
    borderColor: 'border-[#00D4FF]/30',
    title: 'LLM + IoT — Local AI on Edge',
    items: ['Ollama', 'Flask', 'ESP32', 'DHT11'],
    desc: 'Connected ESP32 sensor readings to a local Ollama LLM via Flask gateway — AI generates descriptive summaries of room conditions in real time.',
  },
  {
    year: 'Feb 2026',
    dotColor: 'bg-[#00FF88]',
    ...
    title: 'RPi Agent — AI-Controlled GPIO',
    items: ['Gemini API', 'Raspberry Pi 5', 'AI Agent', 'Flask'],
    desc: 'Built a Gemini-powered agent with a sandbox for Python library management and a code-generation agent to program RPi5 GPIO via natural language.',
  },
  {
    year: 'Apr 2026',
    dotColor: 'bg-[#00FF88]',
    ...
    labelColor: 'text-[#00FF88]',
    borderColor: 'border-[#00FF88]/30',
    title: 'Sensor Dashboard — Live I2C Visualisation',
    items: ['Arduino', 'ENS160', 'AHT21', 'React', 'Vite'],
    desc: 'Team project: React dashboard reading ENS160 + AHT21 I2C sensor data from Arduino over serial, rendering live timestamped graphs.',
  },
  {
    year: 'May 2026',
    dotColor: 'bg-[#00FF88]',
    ...
    labelColor: 'text-[#00FF88]',
    borderColor: 'border-[#00FF88]/30',
    title: 'Frontend Internship — Webytude',
    items: ['React', 'JavaScript', 'HTML/CSS', '3D Physics Simulator'],
    desc: 'Frontend Development Intern at Webytude Web Solutions. Built a 3D Physics Simulator as the capstone project.',
  },
];
